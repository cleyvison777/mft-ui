...
@Component({
  selector: 'app-niveishierarquicos',
  templateUrl: './niveishierarquicos.component.html',
  styleUrls: ['./niveishierarquicos.component.css']
})
export class NiveishierarquicosComponent  {
