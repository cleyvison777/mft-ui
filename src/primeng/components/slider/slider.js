...
var Slider = /** @class */ (function () {
    function Slider(el, domHandler, renderer, ngZone, cd) {
        this.el = el;
    ...
    Slider = __decorate([
        ...
        __metadata("design:paramtypes", [core_1.ElementRef, domhandler_1.DomHandler, core_1.Renderer2, core_1.NgZone, core_1.ChangeDetectorRef])
    ], Slider);
    return Slider;
}());
